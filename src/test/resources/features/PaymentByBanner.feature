...
Feature: Mobile Recharge
  ...
  Scenario Outline: Top up with voucher via promotion banner (13 digit phone number)
    ...
    Examples:
      ...
      | Cashback  | 0859233333333  | 10.000   | available     | Cashback Rp 1.000 buat beli pulsa | Payment Completed       |
      | Cashback  | 0813000000  | 15.000   | available     | Cashback Rp 1.500 buat beli pulsa | Payment Completed       |
